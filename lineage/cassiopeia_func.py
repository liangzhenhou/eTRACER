...
input_files = [fastq_path.format(innerBC,'r1'), fastq_path.format(innerBC,'r2')]	
name = gene_name
output_directory = outdir +'/' + gene_name
reference_filepath = '/syn1/liangzhen/jinhua_jilab_project/reference/cassiopeia_multiome_cDNA_reference/' + gene_name+'.fa'
n_threads = 10
...
bam_fp = cas.pp.error_correct_cellbcs_to_whitelist(
   	bam_fp,
	whitelist='/syn1/liangzhen/jinhua_jilab_project/metadata/737K-arc-v1.txt',
	output_directory=output_directory,
	n_threads=n_threads,
)
