...
#SBATCH -J cassiopeia_multiome
#SBATCH -o /syn1/liangzhen/jinhua_jilab_project/script/AMPLICON/multiome/RNA/log/cassiopeia_multiome.out       
#SBATCH -e /syn1/liangzhen/jinhua_jilab_project/script/AMPLICON/multiome/RNA/log/cassiopeia_multiome.error
#SBATCH -p all
...
fastq_path=/syn1/liangzhen/jinhua_jilab_project/result/DNA_Amplicon/multiome/fastq
